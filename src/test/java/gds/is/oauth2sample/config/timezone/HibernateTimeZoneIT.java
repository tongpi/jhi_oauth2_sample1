package gds.is.oauth2sample.config.timezone;

import gds.is.oauth2sample.JhiOauth2Sample1App;
import gds.is.oauth2sample.config.TestSecurityConfiguration;
import gds.is.oauth2sample.repository.timezone.DateTimeWrapper;
import gds.is.oauth2sample.repository.timezone.DateTimeWrapperRepository;
