package gds.is.oauth2sample.repository;

import gds.is.oauth2sample.JhiOauth2Sample1App;
import gds.is.oauth2sample.config.Constants;
import gds.is.oauth2sample.config.TestSecurityConfiguration;
import gds.is.oauth2sample.config.audit.AuditEventConverter;
import gds.is.oauth2sample.domain.PersistentAuditEvent;
...
import static gds.is.oauth2sample.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
